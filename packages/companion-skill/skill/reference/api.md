...
`"Claude Code, Codex, OpenCode, Grok Bot, OpenClaw, Hermes"`). Grok Bot targets Cursor's supported
`~/.cursor/skills` user-global root and `<project>/.cursor/skills` project root. OpenClaw targets
