...
const registry: SkillVM[] = [
  ...
  mk({
    ...
    teams: [platform],
    teamSlugs: ["platform"],
    owner: { name: "Marek Doan", initials: "MD", handle: "marek", team: "Platform" },
  }),
  mk({ id: "image-ocr", visibility: { everyone: false, teams: [] }, validation: "invalid", owner: { name: "Tomas Okabe", initials: "TO", handle: "tomas", team: null } }),
];
