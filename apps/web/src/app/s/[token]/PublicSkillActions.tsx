...
4. Ask which compatible target to use (Claude Code, Codex, OpenCode, OpenClaw, or Hermes) and whether to install globally or in the current project, then show the resolved destination. For OpenClaw, use ~/.openclaw/skills/<slug> globally or <workspace>/skills/<slug> for the current workspace. Hermes supports only its global source of truth at ~/.hermes/skills/<slug>; do not offer project scope for Hermes. If the destination exists, ask before replacing it.
