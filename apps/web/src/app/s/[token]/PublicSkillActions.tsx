...
4. Ask which compatible target to use (Claude Code, Codex, OpenCode, OpenClaw, or Hermes), then show the resolved destination. For Claude Code, Codex, OpenCode, and OpenClaw, ask whether to install globally or in the current project. For OpenClaw, use ~/.openclaw/skills/<slug> globally or <workspace>/skills/<slug> for the current workspace. Hermes is global-only at ~/.hermes/skills/<slug>; do not offer project scope for Hermes. If the destination exists, ask before replacing it.
