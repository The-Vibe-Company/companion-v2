...
4. Ask which compatible target to use (Claude Code, Codex, OpenCode, or OpenClaw) and whether to install globally or in the current project, then show the resolved destination. For OpenClaw, use ~/.openclaw/skills/<slug> globally or <workspace>/skills/<slug> for the current workspace. If the destination exists, ask before replacing it.
