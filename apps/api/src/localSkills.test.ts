...
describe("companion skill package + row", () => {
  ...
  it("builds a 'none' row with an actionable install prompt for a fresh caller", async () => {
    ...
    expect(changelog).toContain("terse hosted Companion delivery semantics");
    expect(changelog).toContain("projection-only collapsing");
    expect(changelog).toContain("routine history");
