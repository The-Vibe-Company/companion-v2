...
export function buildCompanionSkillPrompts(version: string): LocalSkillPrompts {
  const install = [
    ...
    "8. Ask which tool(s): Claude Code, Codex, OpenCode, OpenClaw, or Hermes. For Claude Code,",
    "   Codex, OpenCode, and OpenClaw, also ask global or project/workspace. Hermes is global-only",
