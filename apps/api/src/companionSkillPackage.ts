...
export function buildCompanionSkillPrompts(version: string): LocalSkillPrompts {
  const install = [
    ...
    "   Codex, OpenCode, Grok Bot, and OpenClaw, also ask global or project/workspace. Grok Bot uses",
    "   ~/.cursor/skills globally and .cursor/skills in a project. Hermes is global-only",
