    ...
    case "$name" in
      COMPANION_*|DATABASE_*|BETTER_AUTH_*|S3_*|STRIPE_*|GITHUB_APP_*|GOOGLE_*|RESEND_*|EMAIL_*|MAILPIT_*|BOX_SIM_*|PI_SIM_*|NEXT_PUBLIC_*|OPENAI_*|ANTHROPIC_*|ZAI_*|AWS_*|*_API_KEY|*_CLIENT_SECRET|*_MASTER_KEY|*_PRIVATE_KEY|*_PASSWORD|*_TOKEN|*_WEBHOOK_SECRET|*_ACCESS_KEY_ID|*_ACCESS_KEY)
        case "$process_role:$name" in
          ...
          runtime:DATABASE_COMPANION_RUNTIME_URL|runtime:COMPANION_DATABASE_POOL_MAX|runtime:COMPANION_API_URL|runtime:COMPANION_COMPANIONS_ENABLED|runtime:COMPANION_COMPANIONS_ALLOWED_EMAIL_DOMAINS|runtime:COMPANION_ROUTINE_ISOLATION_ENABLED|runtime:COMPANION_BOX_*|runtime:COMPANION_PI_*|runtime:COMPANION_RUNTIME_HOST|runtime:COMPANION_RUNTIME_PORT|runtime:COMPANION_RUNTIME_CONCURRENCY|runtime:COMPANION_RUNTIME_SWEEP_INTERVAL_MS|runtime:COMPANION_RUNTIME_EXECUTOR_ID|runtime:COMPANION_RUNTIME_SHUTDOWN_DRAIN_MS|runtime:COMPANION_RUNTIME_DESKTOP_HMAC_SECRET|runtime:COMPANION_SECRETS_MASTER_KEY|runtime:COMPANION_MCP_GITHUB_CLIENT_ID|runtime:COMPANION_MCP_GITHUB_CLIENT_SECRET|runtime:COMPANION_MCP_GMAIL_CLIENT_ID|runtime:COMPANION_MCP_GMAIL_CLIENT_SECRET|runtime:S3_*) ;;
