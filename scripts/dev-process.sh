    ...
    case "$name" in
      COMPANION_*|DATABASE_*|BETTER_AUTH_*|S3_*|STRIPE_*|GITHUB_APP_*|GOOGLE_*|RESEND_*|EMAIL_*|MAILPIT_*|BOX_SIM_*|PI_SIM_*|NEXT_PUBLIC_*|OPENAI_*|ANTHROPIC_*|ZAI_*|AWS_*|*_API_KEY|*_CLIENT_SECRET|*_MASTER_KEY|*_PRIVATE_KEY|*_PASSWORD|*_TOKEN|*_WEBHOOK_SECRET|*_ACCESS_KEY_ID|*_ACCESS_KEY)
        case "$process_role:$name" in
          ...
          api-seed:DATABASE_URL|api-seed:COMPANION_RELEASE_ID|api-seed:COMPANION_DATABASE_POOL_MAX|api-seed:COMPANION_API_HOST|api-seed:COMPANION_API_PORT|api-seed:COMPANION_API_URL|api-seed:COMPANION_WEB_URL|api-seed:COMPANION_COMPANIONS_ENABLED|api-seed:COMPANION_COMPANIONS_ALLOWED_EMAIL_DOMAINS|api-seed:COMPANION_RUNTIME_PRIVATE_URL|api-seed:COMPANION_RUNTIME_DESKTOP_HMAC_SECRET|api-seed:COMPANION_SECRETS_MASTER_KEY|api-seed:COMPANION_AUTH_MODE|api-seed:COMPANION_BILLING_MODE|api-seed:COMPANION_ENTITLEMENTS_MODE|api-seed:COMPANION_ENTITLEMENT_PILOT_ORGS|api-seed:COMPANION_PRO_ORG_ALLOWLIST|api-seed:COMPANION_CHECKOUT_ENABLED|api-seed:COMPANION_STRIPE_WEBHOOKS_ENABLED|api-seed:COMPANION_GITHUB_SYNC_ENABLED|api-seed:COMPANION_GITHUB_APP_MANAGED|api-seed:COMPANION_SKILL_DATABASES_ENABLED|api-seed:COMPANION_SKILL_DB_*|api-seed:COMPANION_MCP_GITHUB_CLIENT_ID|api-seed:COMPANION_MCP_GITHUB_CLIENT_SECRET|api-seed:COMPANION_REQUIRE_VERIFIED_DOMAIN_JOIN|api-seed:COMPANION_ALLOW_TEST_USER_SEED|api-seed:COMPANION_SEED_EMAIL|api-seed:COMPANION_SEED_NAME|api-seed:COMPANION_SEED_PASSWORD|api-seed:BETTER_AUTH_*|api-seed:S3_*|api-seed:STRIPE_*|api-seed:GITHUB_APP_SLUG|api-seed:GITHUB_APP_CLIENT_ID|api-seed:GITHUB_APP_CLIENT_SECRET|api-seed:GITHUB_APP_NAME|api-seed:GOOGLE_*|api-seed:RESEND_API_KEY|api-seed:EMAIL_*|api-seed:MAILPIT_SMTP_*) ;;
