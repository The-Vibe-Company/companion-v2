...
const PHASES = [
  "create", "provider_start", "send_to_prompt_ack", "stage_runtime", "start_pi",
  "broker_preflight", "prompt_ack",
  "create_stage_identity_probe", "create_stage_layout", "create_stage_interaction_extension",
  "create_stage_resource_preflight", "create_stage_control_bundle", "create_stage_skill_transfer",
  "create_stage_skill_apply",
  "ready_to_prompt_ack", "first_message", "stop_archive", "resume",
  "resume_provider_start", "resume_start_pi", "resume_broker_preflight",
  "resume_prompt_ack", "resume_send_to_prompt_ack", "resume_ready_to_prompt_ack", "resume_message",
  "resume_stage_identity_probe", "resume_stage_layout", "resume_stage_interaction_extension",
  "resume_stage_resource_preflight", "resume_stage_control_bundle", "resume_stage_skill_transfer",
...
const PHASE_LABELS = new Map([
  ...
  ["create_stage_identity_probe", "Staging · identité et exécution"],
  ["create_stage_layout", "Staging · layout Pi"],
  ["create_stage_interaction_extension", "Staging · extension Pi"],
  ["create_stage_resource_preflight", "Staging · préflight ressources"],
  ["create_stage_control_bundle", "Staging · bundle de contrôle"],
  ["create_stage_skill_transfer", "Staging · transfert Skills"],
  ["create_stage_skill_apply", "Staging · application Skills"],
  ["provider_start", "Démarrage provider → Box prête"],
  ["send_to_prompt_ack", "Envoi → prompt accepté"],
  ["start_pi", "Démarrage de Pi"],
  ["broker_preflight", "Préflight broker"],
  ...
  ["resume_start_pi", "Reprise · démarrage de Pi"],
  ["resume_broker_preflight", "Reprise · préflight broker"],
  ["resume_prompt_ack", "Prompt de reprise accepté par Pi"],
  ["resume_send_to_prompt_ack", "Envoi de reprise → prompt accepté"],
  ["resume_ready_to_prompt_ack", "Box reprise prête → prompt accepté"],
  ["resume_message", "Message après reprise accepté et répondu"],
  ["resume_stage_identity_probe", "Reprise · identité et exécution"],
  ["resume_stage_layout", "Reprise · layout Pi"],
  ["resume_stage_interaction_extension", "Reprise · extension Pi"],
  ["resume_stage_resource_preflight", "Reprise · préflight ressources"],
  ["resume_stage_control_bundle", "Reprise · bundle de contrôle"],
  ["resume_stage_skill_transfer", "Reprise · transfert Skills"],
  ["resume_stage_skill_apply", "Reprise · application Skills"],
